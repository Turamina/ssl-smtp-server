...
app.post('/api/initiate-payment', async (req, res) => {
    const orderData = {
        ...
        store_id,
        store_passwd,
        success_url: `http://ug2002016.cse.pstu.ac.bd/paymentSuccess`,
        fail_url: `http://ug2002016.cse.pstu.ac.bd/paymentFailed`,
        cancel_url: `http://ug2002016.cse.pstu.ac.bd/paymentCanceled`,
        ipn_url: `http://ug2002016.cse.pstu.ac.bd/ipn`,
        emi_option: 0,
